...
export const UsersTab: React.FC = () => {
  const { users, orders, registerUser } = useEventContext();
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `ticketa_users_${new Date().toISOString().split('T')[0]}.csv`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
        <div>
          <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2">
            ...
            Ticketa Registered Users
          </h2>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Manage customers, view ticket purchase histories, and track active platform attendees.
          </p>
        </div>
