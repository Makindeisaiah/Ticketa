  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">{t('checkInsHeader')}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <table className="w-full text-left text-xs font-semibold">
              <thead className="bg-slate-50 text-slate-400 uppercase text-[10px] tracking-wider border-b border-slate-200">
                <tr>
                  ...
                  <th className="py-3 px-4">{t('checkedInCol')}</th>
                  <th className="py-3 px-4 text-right">{t('remainingCol')}</th>
                </tr>
              </thead>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-4">
          <h3 className="text-base font-extrabold text-slate-900">{t('checkInMethodBreakdown')}</h3>
          <p className="text-xs text-slate-500">{t('gateVerificationSummary')}</p>
            ...
            <div className="space-y-3 text-xs font-bold text-slate-700 flex-1">
              <div className="flex justify-between items-center">
                <span className="flex items-center gap-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-amber-500"></span> {t('qrScanner')}
                </span>
                <span className="font-mono text-slate-900">{checkedInCount}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="flex items-center gap-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span> {t('manualSearch')}
                </span>
                <span className="font-mono text-slate-900">{stillToCheckIn}</span>
              </div>
            </div>
          </div>
        </div>
