              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
                    ...
                    <div className="bg-slate-950 rounded-2xl h-64 border border-slate-800 relative flex flex-col items-center justify-center overflow-hidden">
                      <div className="w-48 h-48 border-2 border-emerald-500/80 rounded-2xl relative flex items-center justify-center">
                      ...
                      <p className="text-[11px] text-slate-400 mt-4">
                        Position QR code within the frame • Scanning will start automatically
                      </p>

                      <div className="absolute top-0 left-0 right-0 h-1 bg-emerald-400 shadow-[0_0_12px_#10b981] animate-pulse"></div>
                    </div>
                    ...
                    {/* Manual Code Form */}
                    <form onSubmit={(e) => { e.preventDefault(); executeScan(scannedInput); }} className="flex gap-2 pt-2">
                      <input
                        type="text"
                        placeholder="Or enter serial code e.g. 7362992662288"
                        value={scannedInput}
          ...
          {currentView === 'scan' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
                ...
                {/* Camera Viewfinder */}
                <div className="bg-slate-950 rounded-2xl h-80 border-2 border-slate-800 relative flex flex-col items-center justify-center overflow-hidden">
                  {isCameraActive ? (
                    <>
                      <div className="w-56 h-56 border-2 border-emerald-500 rounded-3xl relative flex items-center justify-center">
                      ...
                      <p className="text-xs text-slate-300 mt-4">
                        Position QR code within the frame • Scanning start automatically
                      </p>
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-xs text-slate-400">Camera Feed Paused</p>
                    </div>
                  )}
                </div>
